...
?>
<div class="team-holder7 two bmargin <?php print empty($fields['field_highlight']->content) ? '' : 'active'; ?>">
  <div class="team-member"><?php print _views_field($fields, 'field_image'); ?></div>
  <div class="info-box text-center">
    <h4 class="uppercase oswald font-weight-3 less-mar2"><?php print _views_field($fields, 'title'); ?></h4>
    <span class="text-orange-2"><?php print _views_field($fields, 'field_position'); ?></span> <br>
    <br>
    <?php print _views_field($fields, 'body'); ?>
    <br>
    <?php print $links ? theme('links', array('links' => $links, 'attributes' => array('class' => 'social-icons'))) : '';?>
  </div>
</div>
