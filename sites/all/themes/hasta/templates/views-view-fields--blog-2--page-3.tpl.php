...
?>
<div class="blog-holder1">
  <div class="image-holder">
    <div class="post-author-image round overflow-hidden"><?php print _views_field($fields, 'picture'); ?> </div>
    <?php print _views_field($fields, 'field_image'); ?> 
  </div>          
  <div class="content-box">
    <h4 class="less-mar2 droid-serif"><?php print _views_field($fields, 'title'); ?></h4>
