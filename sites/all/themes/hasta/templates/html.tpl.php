...
<body class="appear-animate <?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <?php if(strpos($_SERVER['HTTP_HOST'], 'nikadevs') !== FALSE): ?>
    <link rel="stylesheet" type="text/css" href="<?php print base_path() . drupal_get_path('theme', 'hasta'); ?>/js/style-swicher/style-swicher.css" property='stylesheet' media = "all">
    ...
    <script src="<?php print base_path() . drupal_get_path('theme', 'hasta'); ?>/js/style-swicher/style-swicher.js"></script>
    <script src="<?php print base_path() . drupal_get_path('theme', 'hasta'); ?>/js/style-swicher/custom.js"></script>
  <?php endif; ?>
</body>
</html>